// Pool contract for Project Token
...
contract PoolPRPD {
	...
	address public pop; // POP address
	...
	function deposit(uint256 amount) external {
		...
		IERC20(pop).safeTransferFrom(msg.sender, address(this), amount);
	...
	function withdraw(uint256 amount) external {
		...
		IERC20(pop).safeTransfer(msg.sender, amount);
	...
	function _updateRewards() internal {
		...
		for (uint256 i = 0; i < length; i++) {
			...
			address rewardsContract = IRouter(router).getPopRewards(currency);
